...
BEGIN
    ...
    VALUES (N'20190514022250_InitialMigration', N'2.2.6-servicing-10079');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190514023415_MeetingsTable', N'2.2.6-servicing-10079');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190514024934_AttendeesTable', N'2.2.6-servicing-10079');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190515032706_CreatedAt', N'2.2.6-servicing-10079');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190518004637_FixAttendeeRoleRelation', N'2.2.6-servicing-10079');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200607002730_AddMeetingCancelled')
BEGIN
    ALTER TABLE [Meetings] ADD [Cancelled] bit NOT NULL DEFAULT 0;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200607002730_AddMeetingCancelled', N'2.2.6-servicing-10079');
END;
