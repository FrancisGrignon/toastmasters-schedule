    ...
    public class MeetingContextSeed
    {
        ...
        private IEnumerable<Role> GetPreconfiguredRoles()
        {
            return new List<Role>()
            {
                ...
                new Role() { Id = 11, Active = true, Order = 1100, Name = "Grammarian", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new Role() { Id = 12, Active = true, Order = 1110, Name = "Écouteur", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new Role() { Id = 13, Active = true, Order = 1120, Name = "Chronométreur", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new Role() { Id = 14, Active = true, Order = 1130, Name = "Membre", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new Role() { Id = 15, Active = true, Order = 1140, Name = "Visiteur", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow }
            };
        }
